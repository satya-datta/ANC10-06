...
try {
    ...
    if (!$beneficiary) {
        header("Location: listbeneficiary.php");
        exit();
    }
    
} catch(PDOException $e) {
    $error_message = "Error fetching beneficiary: " . $e->getMessage();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt->bindParam(':register_date', $_POST['register_date']);
        $stmt->bindParam(':lmp', $_POST['lmp']);
        $stmt->bindParam(':edd', $_POST['edd']);
        ...
        $success_message = "Beneficiary record has been successfully updated!";
...
<!-- Header Section ends -->
    <!-- Header Section end -->
        ...
        <div class="row m-1">
            <div class="col-12 ">
                <h4 class="main-title">BENEFICIARY REVISE</h4>
                <ul class="app-line-breadcrumbs mb-3">
                    ...
                    <li class="active">
                        <a href="#" class="f-s-14 f-w-500">Beneficiary Revise</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-success">
                            ...
                            <a href="listbeneficiary.php" class="btn btn-secondary float-end">View List</a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex flex-column gap-2">
                        <h5>BENEFICIARY REVISE</h5>
                        <div>
                            <p> The Beneficiary Revise feature allows user to update the existing beneficiary 
                            </p>
                        </div>
                    </div>
                    <div class="card-body">
                          <form class="app-form row g-3 needs-validation" method="POST" novalidate>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom01" name="rch_id"
                                               value="<?php echo htmlspecialchars($beneficiary['rch_id'] ?? ''); ?>"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom02" name="beneficiary_name"
                                               value="<?php echo htmlspecialchars($beneficiary['beneficiary_name'] ?? ''); ?>"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="validationCustom03" name="husband_name"
                                               value="<?php echo htmlspecialchars($beneficiary['husband_name'] ?? ''); ?>"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="gravidaInput" name="gravida"
                                               value="<?php echo htmlspecialchars($beneficiary['gravida'] ?? ''); ?>"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="paraInput" name="para"
                                               value="<?php echo htmlspecialchars($beneficiary['para'] ?? ''); ?>"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="registerDate" name="register_date"
                                               value="<?php echo htmlspecialchars($beneficiary['register_date'] ?? ''); ?>"
                                               required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="lmpDate" name="lmp"
                                               value="<?php echo htmlspecialchars($beneficiary['lmp'] ?? ''); ?>"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="eddDate" name="edd"
                                               value="<?php echo htmlspecialchars($beneficiary['edd'] ?? ''); ?>"
                                               required readonly>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select" id="citySelect" name="city" required>
                                            ...
                                            <option value="City1" <?php echo (isset($beneficiary['city']) && $beneficiary['city'] == 'City1') ? 'selected' : ''; ?>>City 1</option>
                                            <option value="City2" <?php echo (isset($beneficiary['city']) && $beneficiary['city'] == 'City2') ? 'selected' : ''; ?>>City 2</option>
                                            <option value="City3" <?php echo (isset($beneficiary['city']) && $beneficiary['city'] == 'City3') ? 'selected' : ''; ?>>City 3</option>
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="pincodeInput" name="pincode"
                                               value="<?php echo htmlspecialchars($beneficiary['pincode'] ?? ''); ?>"
                                    ...
                                    <div class="col-12">
                                        <div class="form-check d-flex flex-wrap gap-1">
                                            <input class="form-check-input mg-2" type="checkbox" name="data_confirmed" 
                                                   ...
                                                   <?php echo (isset($beneficiary['data_confirmed']) && $beneficiary['data_confirmed'] == 1) ? 'checked' : ''; ?>>
            ...
            <!-- Custom Styles end -->
       <script>
        // Calculate EDD when page loads if LMP exists
